...
public class DataTable_StepDefinition {
    ...
    public void userShouldSeeBelowInfoInMonthDropdown(List<String> expectedMonths) {
        ...
        List<String> actualMonths = BrowserUtil.dropdownOptionsAsString(dropdownsPage.monthsDropdown);
        Assert.assertEquals(expectedMonths, actualMonths);
        //Assert will check the size of the Lists first, if it matches, it will check content 1 by 1
    }
}
